...
var ProductStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot get products with id= ".concat(id, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not update new product ".concat(p.name, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    // Delete Product
    ProductStore.prototype.destroy = function (id) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ProductStore.prototype.topFivePopularProducts = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Cannot get top five popular products. Error: ".concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_7 = _a.sent();
                        throw new Error("Cannot get products by category. Error: ".concat(err_7));
                    case 4: return [2 /*return*/];
                }
            });
        });
