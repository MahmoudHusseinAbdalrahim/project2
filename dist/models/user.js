...
var UserStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot get users with id= ".concat(id, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        hash = bcrypt_1["default"].hashSync(u.password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, conn.query(sql, [u.first_name, u.last_name, hash, id])];
                    case 2:
                        result = _a.sent();
                        user = result.rows[0];
                        conn.release();
    ...
    UserStore.prototype.destroy = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, userDel, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        result = _a.sent();
                        userDel = result.rows[0];
                        conn.release();
                        return [2 /*return*/, userDel];
                    case 3:
                        err_5 = _a.sent();
    ...
    UserStore.prototype.resetCol = function () {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, userReset, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = 'Alter SEQUENCE users_id_seq RESTART';
                        return [4 /*yield*/, conn.query(sql)];
                    case 2:
                        result = _a.sent();
                        userReset = result.rows[0];
                        conn.release();
                        return [2 /*return*/, userReset];
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not reset user id. Error: ".concat(err_6));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_7 = _a.sent();
                        throw new Error("Could not athenticate user. Error: ".concat(err_7));
                    case 4: return [2 /*return*/];
                }
            });
        });
