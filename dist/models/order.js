...
var OrderStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Cannot get orders. Error: ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Cannot get orders with id= ".concat(id, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new order with id = ".concat(o.id, ". Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    // Update Order
    OrderStore.prototype.update = function (id, o) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not update new order with id = ".concat(id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    OrderStore.prototype.destroy = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, orderDel, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 2:
                        result = _a.sent();
                        orderDel = result.rows[0];
                        conn.release();
                        return [2 /*return*/, orderDel];
                    case 3:
                        err_5 = _a.sent();
    ...
    OrderStore.prototype.orderByUser = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_8 = _a.sent();
                        throw new Error("Cannot get order by user id = ".concat(user_id, ". Error: ").concat(err_8));
                    case 4: return [2 /*return*/];
                }
            });
        });
    ...
    OrderStore.prototype.completedOrderByUser = function (user_id) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, err_9;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_9 = _a.sent();
                        throw new Error("Cannot get order by user id = ".concat(user_id, ". Error: ").concat(err_9));
                    case 4: return [2 /*return*/];
                }
            });
        });
