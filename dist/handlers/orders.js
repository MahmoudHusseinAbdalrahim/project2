    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, store.update(req.params.id, order)];
            case 1:
...
var verifyAuthToken = function (req, res, next) {
    try {
        ...
        res.status(401);
        res.json("Invaled token ".concat(err));
        return;
    }
};
...
var orderByuser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order, err_7;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.orderByUser(req.params.user_id)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
...
var completedOrderByuser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var order, err_8;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.completedOrderByUser(req.params.user_id)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
